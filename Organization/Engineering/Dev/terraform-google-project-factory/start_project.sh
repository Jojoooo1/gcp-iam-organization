...
createProjectWithinFolder $PROJECT_NAME $FOLDER_ID
...
createServiceAccount $PROJECT_SERVICE_ACCOUNT_ID "Terraform admin service account"
...
# grantRolesOnFolder $PROJECT_SERVICE_ACCOUNT_ID $FOLDER_ID
